...
sorted chronologically by most recent
    sorting options are unecessary

identify use cases

nav calls to action should be consistent
comment on vs comment in?
sorting
...
tools:
	...
	caveats
		working from generated markup is extremely difficult
